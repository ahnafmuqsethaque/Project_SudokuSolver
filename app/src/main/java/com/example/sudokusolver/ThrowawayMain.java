...
//
//    public static void main(String[] args) {
//        String test = "020000000000600003074080000000003002080040010600500000000010780500009000000000040";
//
//        int[][] testBoard = new int[9][9];
//        for (int i = 0; i < 9; i++) {
//            for (int j = 0; j < 9; j++) {
//                testBoard[i][j] = Integer.parseInt(test.substring(9*i + j, 9*i + j + 1));
//            }
//        }
//
//
//        SudokuSolver solver = new SudokuSolver();
//        int[][] solvedBoard = solver.solveBoardv2(testBoard);
//
//        for (int i = 0; i < 9; i++) {
//            for (int j = 0; j < 9; j++) {
//                System.out.println(solvedBoard[i][j]);
//            }
//        }
//
//    }
